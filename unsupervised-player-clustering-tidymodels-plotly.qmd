...
- Load and explore CS2 match player statistics in R.
- Select and preprocess numeric features for clustering.
- Perform k-means clustering using tidymodels-style preprocessing.
- Use PCA to visualize players in two dimensions.
- Build several **interactive plotly visualizations** step by step (raw stats, PCA space, and clusters).
- Interpret and summarize cluster “player types”.
...
plot_ly(
  ...
  type = "scatter",
  mode = "markers",
  # TODO: pick a size and opacity
  marker = list(size = ___, opacity = ___),
  # TODO: map color to performance_score 
  color = ~___,
  #TODO: show player_name and kills when hover
...
plot_ly(
  ...
  text = ~paste(
    ...
    "<br>Kills:", _______,      # TODO: Insert kills
    "<br>Deaths:", _______,     # TODO: Insert deaths
    "<br>ADR:", _______,        # TODO: Insert adr
    "<br>Perf Score:", _______  # TODO: Insert performance_score
  ),
  hoverinfo = "text"
) %>%
  layout(
...
We have already computed, for each point on a grid in PCA space, the distance to the nearest cluster center and stored it in heatmap_matrix. Your task is to visualize this as a Plotly heatmap.
